...
async def get_st(_, msg: Message):
    ...
    await msg.reply_photo(photo="https://te.legra.ph/file/68fa108d07007d78d71ef.png",
...
print(f"{BOT_NAME} ɪs ᴀʟɪᴠᴇ! ɴᴏᴡ ғᴜᴄᴋ ᴏғғ! ᴀɴᴅ ɢᴏ ᴛᴏ @ODDRAGONS ʙɪᴛᴄʜ!!")      
bot.run()
